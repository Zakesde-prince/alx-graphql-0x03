...
const EpisodeCard = ({ id, name, air_date, episode }: EpisodeCardProps) => {
  return (
    <div className="bg-white cursor-pointer shadow-md rounded-lg p-4 transition-transform duration-200 hover:scale-105">
      ...
      <p className="text-gray-600 mt-2">{air_date}</p>
    </div>
  );
};
